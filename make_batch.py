...
def make_batch(batch_size,
    ...
    util.pickle_save(image_path_out, images)
    util.pickle_save(label_path_out, labels)
...
def main():
    ...
    # train
    make_batch(mnist.TRAIN_BATCH_SIZE,
               mnist.TRAIN_IMAGE_PATH,  mnist.TRAIN_LABEL_PATH,
               mnist.TRAIN_IMAGE_BATCH_PATH, mnist.TRAIN_LABEL_BATCH_PATH)
    # test
