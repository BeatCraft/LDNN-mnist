...
def main():
    ...
    dh.saveBatch(train_batch_data, train_batch_label, "./work/1-train_data.pickle", "./work/1-train_label.pickle")
    dh.saveBatch(test_batch_data, test_batch_label, "./work/1-test_data.pickle", "./work/1-test_label.pickle")
