...
class DataHandler(object):
    ...
    def tail(self, offset):
        h = []
        for i in range(self.num_class):
            h.append(self.container[i][offset:])
        #
        return h
...
def main():
    ...
    dh = DataHandler(mnist.IMAGE_SIZE, mnist.NUM_CLASS)
    ...
    batch_size = 100*mnist.NUM_CLASS
    batch_offset = 0
...
#    util.pickle_save("./sb/data.pickle", batch_data)
#    util.pickle_save("./sb/lavel.pickle", batch_label)
