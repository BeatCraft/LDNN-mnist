...
def main():
    ...
    test_batch_data = util.pickle_load("./work/2-test_data.pickle")
    test_batch_label = util.pickle_load("./work/2-test_label.pickle")
    ...
    dh.load("./work/2-test_data.pickle", "./work/2-test_label.pickle")
    
    correct_data, correct_label = dh.extract(correct)
    dh.saveBatch(correct_data, correct_label, "./work/2-correct_data.pickle", "./work/2-correct_label.pickle")
    
    incorrect_data, incorrect_label = dh.extract(incorrect)
    dh.saveBatch(incorrect_data, incorrect_label, "./work/2-incorrect_data.pickle", "./work/2-incorrect_label.pickle")
    return 0
#
#
#
