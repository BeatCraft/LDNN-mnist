...
def main():
    ...
    dh.load("./work/1-incorrect_data.pickle", "./work/1-incorrect_label.pickle")
    dh.shuffle()
    ...
    dh.saveBatch(train_batch_data, train_batch_label, "./work/2-train_data.pickle", "./work/2-train_label.pickle")
    dh.saveBatch(test_batch_data, test_batch_label, "./work/2-test_data.pickle", "./work/2-test_label.pickle")
